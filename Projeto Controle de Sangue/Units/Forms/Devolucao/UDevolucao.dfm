object FrmDevolucao: TFrmDevolucao
  ...
  Caption = 'Devolu'#231#227'o de bolsa de sangue'
  ClientHeight = 266
  ClientWidth = 422
  Color = clBtnFace
  ...
  object PanelClient: TPanel
    ...
    object LabelOrigemDevolucao: TLabel
      Left = 19
      Top = 95
      Width = 115
      Height = 13
      Caption = 'Origem da devolu'#231#227'o(*)'
    end
    ...
    object EdtDataDevolucao: TDateTimePicker
      Left = 85
      Top = 23
      Width = 102
      Height = 21
    ...
    object EdtOrgiemDevolucao: TEdit
      Left = 19
      Top = 111
      Width = 381
      Height = 21
