object FrmConfiguracoes: TFrmConfiguracoes
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object EdtQuantDiasAvisoVencimento: TLabeledEdit
    Left = 8
    Top = 27
    Width = 281
    Height = 21
    EditLabel.Width = 194
    EditLabel.Height = 13
    EditLabel.Caption = 'Quantidade de dias aviso do vencimento'
    TabOrder = 0
  end
  object PanelBotoes: TPanel
    ...
    object BtnGravar: TBitBtn
      ...
      Height = 25
      Hint = 
        'Gravar as informa'#231#245'es do usu'#225'rio. Voc'#234' pode utilizar o atalho pr' +
